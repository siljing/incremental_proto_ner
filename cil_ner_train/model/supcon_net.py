...
class MySftBertModel(BertPreTrainedModel):
    ...
    def new_classifier(self):
        ...
        print("Old classifier weight size:", self.classifier.weight.data.size())
        print("New classifier weight size:", new_cls.weight.data.size())
        print("Number of labels:", self.num_labels)
        print("Per types:", self.per_types)
